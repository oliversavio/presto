        ...
        implements Lookup
{
    ...
    private TestingLookup(
            StatsCalculator statsCalculator,
            CostCalculator costCalculator,
            Map<PlanNode, PlanNodeStatsEstimate> stats,
            Map<PlanNode, PlanNodeCostEstimate> costs,
            Function<GroupReference, PlanNode> resolver)
    {
    ...
    {
        return Stream.of(resolver.apply((GroupReference) node));
    }
