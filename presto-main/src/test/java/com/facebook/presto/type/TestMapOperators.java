        ...
        extends AbstractTestFunctions
{
            ...
            throws Exception
    {
        ...
        assertFunction("MAP_KEYS(MAP(ARRAY[from_unixtime(1)], ARRAY[1.0E0]))", new ArrayType(TIMESTAMP), ImmutableList.of(sqlTimestamp(1000)));
    ...
    {
        return sqlTimestampOf(millis, TEST_SESSION);
    }
