...
public class TestCachingCostCalculator
{
    ...
    private final Map<Symbol, Type> types = emptyMap();
    ...
    public void test()
    {
        ...
        Lookup lookup = Lookup.from(node -> { throw new UnsupportedOperationException(); }, (node, lookup1, session, types) -> null, costCalculator);
