        ...
        extends ProductTest
{
    ...
    public void testStatisticsForAllDataTypes()
    {
        ...
        assertThat(query("SHOW STATS FOR " + tableNameInDatabase)).containsOnly(
                row("c_tinyint", null, anyOf(1.0, 2.0), 0.0, null, "121", "127"),
                row("c_smallint", null, anyOf(1.0, 2.0), 0.0, null, "32761", "32767"),
                row("c_int", null, anyOf(1.0, 2.0), 0.0, null, "2147483641", "2147483647"),
                row("c_bigint", null, anyOf(1.0, 2.0), 0.0, null, "9223372036854775801", "9223372036854775807"),
                row("c_float", null, anyOf(1.0, 2.0), 0.0, null, "123.341", "123.345"),
                row("c_double", null, anyOf(1.0, 2.0), 0.0, null, "234.561", "234.567"),
                row("c_decimal", null, anyOf(1.0, 2.0), 0.0, null, "345", "346"),
                row("c_decimal_w_params", null, anyOf(1.0, 2.0), 0.0, null, "345.67100", "345.67800"),
                row("c_timestamp", null, anyOf(1.0, 2.0), 0.0, null, "2015-05-10 12:15:31.000", "2015-05-10 12:15:35.000"),
                row("c_date", null, anyOf(1.0, 2.0), 0.0, null, "2015-05-09", "2015-05-10"),
                row("c_string", null, anyOf(1.0, 2.0), 0.0, null, null, null),
                row("c_varchar", null, anyOf(1.0, 2.0), 0.0, null, null, null),
                row("c_char", null, anyOf(1.0, 2.0), 0.0, null, null, null),
                row("c_boolean", null, anyOf(1.0, 2.0), 0.0, null, null, null),
